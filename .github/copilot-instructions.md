# Copilot Instructions: ai_drones
...
```
ai_drones/
├── ops/              # Docker compose for MQTT broker
├── sim/              # Fleet simulator and fault injector
├── docs/             # Documentation
├── tests/            # Test files
└── .context/
    ├── project/      # Project docs (architecture, ADRs) - committed
...
**Examples:**
- `feature/42-mqtt-telemetry-stream`
- `fix/99-fault-injector-timing`
- `docs/55-setup-instructions`
...
**Example:**
```
feat(mqtt): add telemetry streaming for drone fleet
